...
public class ServerListController: UIViewController {
  private enum Segues {
  ...
  public weak var dismissDelegate: DismissControllerDelegate?
  
  public var serverListInfo: ServerListResponse? {
    didSet {
  ...
  @IBAction func nextButtonAction(_ sender: Any) {
    ...
    IdentityService.getServiceInfo(url: serviceURL) { [weak self] info, error in
      ...
      TicketingConnection.loadAccessToken(url, servicePath: service.id, publicKey: pubKey) { response, error in
