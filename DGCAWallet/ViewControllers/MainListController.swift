...
class MainListController: UIViewController {
    ...
    func showAlertReloadDatabase() {
        let alert = UIAlertController(title: "Reload data?".localized,
                                      message: "The update may take some time.".localized,
    ...
    @IBAction func addNew() {
        ...
        let menuActionSheet = UIAlertController(title: "Add new?".localized,
                                                message: "Do you want to add new certificate, image or PDF file?".localized,
        ...
        menuActionSheet.addAction(UIAlertAction(title: "Cancel".localized,
...
extension MainListController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case TableSection.multiTypeCertificates.rawValue:
            ...
            case .icao:
                self.performSegue(withIdentifier: SegueIdentifiers.showSavedICAOCertificate,
                                  sender: certificates[indexPath.row])
            case .divoc:
                self.performSegue(withIdentifier: SegueIdentifiers.showSavedDIVOCCertificate,
                                  sender: certificates[indexPath.row])
            case .shc:
        ...
        case TableSection.images.rawValue:
            self.performSegue(withIdentifier: SegueIdentifiers.showImageViewer,
                              sender: listImageElements[indexPath.row])

        case TableSection.pdfs.rawValue:
            self.performSegue(withIdentifier: SegueIdentifiers.showPDFViewer,
                              sender: listPdfElements[indexPath.row])
...
extension MainListController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func openCamera() {
        if UIImagePickerController.isSourceTypeAvailable(.camera) {
            ...
            let alertController: UIAlertController = {
                let controller = UIAlertController(title:"Cannot scan".localized,
                                                   message: "You don't have a camera.".localized,
                                                   preferredStyle: .alert)
